...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular('unidade_socioeducativa', 'unidades_socioeducativas')
  inflect.irregular('socioeducando_atendido', 'socioeducandos_atendidos')
  inflect.irregular('gestor_area', 'gestores_areas')
  inflect.irregular('gestor_eixo', 'gestores_eixos')
  inflect.irregular('gestor_unidade', 'gestores_unidades')
  inflect.irregular('servico_realizado', 'servicos_realizados')
  inflect.irregular('capacidade_original', 'capacidades_originais')
  inflect.irregular('capacidade_diaria', 'capacidades_diarias')
end
